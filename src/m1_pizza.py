...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    # Test 3:
    title = 'DRAW_POINTS_ON_CIRCLE, test 3:  20 yellow dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(points)):
        ...
        draw_points = rg.Point(points[k].x, points[k].y)
        draw_points.attach_to(window)
    window.render()
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    # Test 3:
    title = 'PIZZA test 3:  300 slices, thin (thickness=1) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    # Tests 3:
    title = 'POLYGON tests 3:  4 segments' + \
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  20 blue' + \
            ' on a circle, hops = 5.'
    window = rg.RoseWindow(480, 350, title)
